...
import LoginLeft from "../static/images/signup-left.png";
import Vctimgimg5 from "../static/images/vctimgimg5.png";
import Vctimgimg4 from "../static/images/vctimgimg4.png";
import LoginGraph from "../static/images/signup-graph.png";
...
export const GetStartedView = () => {
    ...
    return (
        <>
            <HeaderView />
            <div className="sliderpart featureslide signpage"> 
                ...
                <div className="container-fluid">
                    <div className="get-started-container">
                            <div className="get-section d-flex justify-content-center ">
                            ...
                            <div className="col-lg-10 m-auto">
                                <div className="form-container ">
                                    <form>
                                        ...
                                        <div className="col-md-12">
                                            <div className="form-group">
                                                <button type="submit" className="ActiveButton button-Effect col-md-6" >Add Payment Details <img src={RightArrow} alt="right-arrow" /></button>
                                            </div>
                                        </div>
                                ...
                                <div className="d-flex justify-content-between q-singprt">
                                    <div className="row">
